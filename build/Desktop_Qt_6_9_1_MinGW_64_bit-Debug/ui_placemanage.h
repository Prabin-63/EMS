...
"}"));
        ...
        subEventContainer->setGeometry(QRect(0, 0, 791, 531));
...
"}"));
        ...
        removeSubEvent = new QPushButton(widget_4);
        removeSubEvent->setObjectName("removeSubEvent");
        removeSubEvent->setStyleSheet(QString::fromUtf8("QPushButton{\n"
"background-color:rgb(55,55,55);\n"
"color:white;\n"
"border:none;\n"
"}"));

        horizontalLayout_5->addWidget(removeSubEvent);
...
"}"));
    ...
    void retranslateUi(QMainWindow *placemanage)
    {
        ...
        addSubEventButton->setText(QCoreApplication::translate("placemanage", "PushButton", nullptr));
        removeSubEvent->setText(QCoreApplication::translate("placemanage", "PushButton", nullptr));
        pushButton->setText(QCoreApplication::translate("placemanage", "Save", nullptr));
    } // retranslateUi
